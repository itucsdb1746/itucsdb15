...
#match table inserting data
    ...
    cursor.execute("""INSERT INTO match (matchTime, matchDate, homeTeamId, homeTeamScore, guestTeam, guestTamScore, result)
                                    VALUES('21:45' ,'22/11/2017', '5', 0, '6', 0, 0)""")
    cursor.execute("""INSERT INTO match (matchTime, matchDate, homeTeamId, homeTeamScore, guestTeam, guestTamScore, result)
                                    VALUES('21:45' ,'22/11/2017', '7', 0, '8', 0, 0)""")
    cursor.execute("""INSERT INTO match (matchTime, matchDate, homeTeamId, homeTeamScore, guestTeam, guestTamScore, result)
                                    VALUES('21:45' ,'22/11/2017', '9', 0, '10', 0, 0)""")
    cursor.execute("""INSERT INTO match (matchTime, matchDate, homeTeamId, homeTeamScore, guestTeam, guestTamScore, result)
                                    VALUES('21:45' ,'22/11/2017', '11', 0, '12', 0, 0)""")
    cursor.execute("""INSERT INTO match (matchTime, matchDate, homeTeamId, homeTeamScore, guestTeam, guestTamScore, result)
                                    VALUES('21:45' ,'22/11/2017', '13', 0, '14', 0, 0)""")
    cursor.execute("""INSERT INTO match (matchTime, matchDate, homeTeamId, homeTeamScore, guestTeam, guestTamScore, result)
                                    VALUES('21:45' ,'22/11/2017', '15', 0, '16', 0, 0)""")
    cursor.execute("""INSERT INTO match (matchTime, matchDate, homeTeamId, homeTeamScore, guestTeam, guestTamScore, result)
                                    VALUES('21:45' ,'22/11/2017', '17', 0, '18', 0, 0)""")
    cursor.execute("""INSERT INTO match (matchTime, matchDate, homeTeamId, homeTeamScore, guestTeam, guestTamScore, result)
                                    VALUES('21:45' ,'22/11/2017', '19', 0, '20', 0, 0)""")
